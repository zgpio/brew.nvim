...
echo "Please add the following settings for dein to the top of your vimrc (Vim) or init.vim (NeoVim) file:"
{
    ...
    echo "  lua dein.begin('$PLUGIN_DIR')"
    echo ""
    echo "  \" Let dein manage dein"
    echo "  \" Required:"
    echo "  lua dein.add('$INSTALL_DIR')"
    echo ""
    echo "  \" Add or remove your plugins here like this:"
    echo "  \"lua dein.add('Shougo/neosnippet.vim')"
    echo "  \"lua dein.add('Shougo/neosnippet-snippets')"
    echo ""
    echo "  \" Required:"
    echo "  lua dein.end()"
    echo "  lua dein.save_state()"
    echo "endif"
    echo ""
    echo "\" Required:"
    ...
    echo "\"if v:lua.dein.check_install()"
    echo "\"  call v:lua.dein.install()"
    echo "\"endif"
    echo ""
